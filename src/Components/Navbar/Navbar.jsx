    ...
    return (
            ...
            <div className="flex justify-between items-center h-16">
                ...
                <div className="hidden md:block">
                    <ul className="flex space-x-4">
                        ...
                        <li><Link to="/login" className="border-gray-200 border-2 hover:bg-white hover:drop-shadow-sm px-3 py-2 rounded-md">Login</Link></li>
                        <li><Link to="/login" className="bg-blue text-white hover:bg-blue hover:drop-shadow-md px-4 py-2 rounded-md">Sign Up</Link></li>
        ...
        <div className={`${isOpen ? 'block' : 'hidden'} md:hidden`}>
            <ul className="bg-gray-100">
                ...
                <li><Link to="/" className="block  hover:bg-gray-50 px-3 py-2">Blog</Link></li>
                <li><Link to="/" className="block  hover:bg-gray-50 px-3 py-2">Products</Link></li>
                <li><Link to="/" className="block  hover:bg-gray-5 px-3 py-2">Contact</Link></li>
                <li><Link to="/" className="block bg-black w-[60px] ml-3 mb-2 rounded text-white  hover:bg-gray-5 px-2 py-1">Login</Link></li>
